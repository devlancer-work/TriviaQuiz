...
const mainQuestionDemo = document.querySelector('.question_container');
...
xhr.open('GET', 'https://opentdb.com/api.php?amount=10&category=17&difficulty=easy&type=multiple', true);
xhr.onload = function(){
...
function getNewQuestion(){
    ...
    // Show Question
    mainQuestionDemo.innerHTML = `<p id="question">${currentQuestion.question}</p>`;
...
function loadChoices(choices){
    ...
    options.forEach(function(option) {
        ...
        option.innerHTML = `<p class="option-data">${currentChoices[num-1]}</p>`;
    });
